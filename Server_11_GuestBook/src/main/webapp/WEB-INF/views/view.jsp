	 ...
	 document.querySelector("div.view_btn").addEventListener("click",function(ev){
		 ...
		 if(className=="btn_home"){
			 ...
			 if(confirm("방명록을 삭제합니다")){
				 // document.location.href=url과
				 // document.location.replace(url)
				 // 새로운 페이지에서 뒤로가기를 하면 현재 페이지로 되돌아 올수있다
				 
				 // href는 새로운 페이지를 열고 url에서 resp한 정보를 보여준다
				 // replace()는 현재 페이지에서 url에서 resp한 정보를 보여준다
				 // 새로운 페이지에서 뒤로가기를 했을때 현재 페이지를 볼수없다
...
<link href="${rootPath}/static/css/home.css?ver2021-05-18-002"
	rel="stylesheet" />
</head>
<body>
