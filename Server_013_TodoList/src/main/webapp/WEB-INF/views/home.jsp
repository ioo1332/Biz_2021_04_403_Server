...
/* 화면폭이 800ox 이하(max)일때 적용할 style */
...
/* 화면폭이 480ox 이하(max)일때 적용할 style */
...
<body>
	...
	<table class="td_list">
		<c:forEach items="${TDLIST}" var="TD" varStatus="ST">
			<tr data-seq="${TD.td_seq}" date-edate="${TD.td_edate}">
